...
#servoPan(cam_pan)
#servoTilt(cam_tilt)
#setNeoPixel(0, (128,128,128))
#setNeoPixel(7, (128,128,128))
...
#	cv2.circle(frame, (160, 120), 10, (0, 255, 0), 2)
#	color = hsv[160,120]
#	print color
#	rgb = h2rgb(color[0])
#	print rgb
#	#setNeoPixel(3, rgb)
#	#setNeoPixel(4, rgb)
#	cv2.putText(frame, str(color), (10, 50), cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 0), 2)
